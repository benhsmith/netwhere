...
The frontend part of this is a prototype to see what I can do with the data available from the backend. It's fairly minimal and the code is pretty haphazard.
